...
function exec(poolOrClientOrNull, query, callback) {
  // default to the pool
  poolOrClientOrNull = poolOrClientOrNull || pool

  poolOrClientOrNull.query(query, callback)
}

function getOne(poolOrClientOrNull, query, callback) {
  // default to the pool
  poolOrClientOrNull = poolOrClientOrNull || pool
  ...
  poolOrClientOrNull.query(query, (err, res) => {
...
function getAllArr(poolOrClientOrNull, query, callback) {
  // default to the pool
  poolOrClientOrNull = poolOrClientOrNull || pool
...
function getAllObj(poolOrClientOrNull, query, name, callback) {
  // default to the pool
  poolOrClientOrNull = poolOrClientOrNull || pool
...
function insObj(poolOrClientOrNull, obj, tablename, callback) {
  // default to the pool
  poolOrClientOrNull = poolOrClientOrNull || pool
  ...
  console.log('insObj() - query:', query)
  exec(poolOrClientOrNull, query, callback)
}
